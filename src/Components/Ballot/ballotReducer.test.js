...
const getInitialState = () => ballotReducer(initialState, {
  type: 'init',
  payload: data,
});
...
test('it should toggle selection correctly', () => {
  const state = ballotReducer(getInitialState(), {
    type: 'toggle',
    payload: {
      awardId: 'best-picture',
      nomineeId: 'nomadland'
    }
  })
